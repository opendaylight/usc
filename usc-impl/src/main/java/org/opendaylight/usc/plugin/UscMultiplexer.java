...
/**
 * This class takes all the inputs from the various client sessions and
 * multiplexes them into the combined USC channel.
 */
@Sharable
public class UscMultiplexer extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        UscSessionImpl session = ch.attr(UscPlugin.SESSION).get();
