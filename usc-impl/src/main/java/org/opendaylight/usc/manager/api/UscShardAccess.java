 ...
 */
public interface UscShardAccess<D extends DataObject, R> {
     ...
     */
    public void write(LogicalDatastoreType type, InstanceIdentifier<D> id, D data);
     ...
     */
    public void write(LogicalDatastoreType type, InstanceIdentifier<D> id, D data, FutureCallback<R> callback);
     ...
     */
    public void merge(LogicalDatastoreType type, InstanceIdentifier<D> id, D data);
     ...
     *            for dealing with the operation result
     */
    public void merge(LogicalDatastoreType type, InstanceIdentifier<D> id, D data, FutureCallback<R> callback);
